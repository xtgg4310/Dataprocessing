...
if __name__ == '__main__':
    ...
    while test_total_count < 100:
        ...
        while test_count < 1:
            ...
            h_min_1 = max(op.h_start_min, op.h_min_2[0], op.h_min_3[0], op.h_min_[0][0])
            h_max_1 = min(op.h_start_max, op.h_max_2[0], op.h_max_3[0], op.h_max_[0][0])
            h_min_2 = max(op.h_end_min, op.h_min_2[1], op.h_min_3[1], op.h_min_[0][1])
            h_max_2 = min(op.h_end_max, op.h_max_2[1], op.h_max_3[1], op.h_max_[0][1])
            ...
            for i in range(len(x)):
                for j in range(len(y)):
                    value[i][j] = op.function_to_target_sonar_more(x1[i][j], y1[i][j], 1)
                    if value[i][j] > -160:
                        if flag:
            ...
            print(op.function_to_target_several(z1, z2, 0))
